...
class CategoryRepository implements ICategoryRepository {
  ...
  Future<List<CategoryModel>> list() async {
    final categoriesCollection = await _firestore.collection(categoryCollection).get();
    final categories = <CategoryModel>[];

    for (var categoryDoc in categoriesCollection.docs) {
      final subCategories = await categoryDoc.reference.collection(subCategoryCollection).get();
