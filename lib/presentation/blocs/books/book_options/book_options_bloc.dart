...
class BookOptionsBloc extends Bloc<BookOptionsEvent, BookOptionsState> {
  ...
  Future<void> _onDeleteReadHistoryEvent(DeleteReadHistoryEvent event, Emitter<BookOptionsState> emit) async {
    final result = await _deleteReadHistoryUsecase(RemoveReadHistoryModel(event.bookId, event.historyId));
  ...
  FutureOr<void> _onSetReadMetaEvent(SetReadMetaEvent event, Emitter<BookOptionsState> emit) {}
